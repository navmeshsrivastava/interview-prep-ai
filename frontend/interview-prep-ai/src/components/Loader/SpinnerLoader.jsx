...
const SpinnerLoader = () => {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className="inline w-5 h-5 animate-spin text-gray-300 fill-white"
        viewBox="0 0 100 101"
        fill="none"
      ...
      >
        <path
          ...
          100 50.5908ZM9.08144 50.5908C9.08144 73.1865 
          27.4043 91.5094 50 91.5094C72.5957 91.5094 
          90.9186 73.1865 90.9186 50.5908C90.9186 
          27.9951 72.5957 9.67221 50 9.67221C27.4043 
          9.67221 9.08144 27.9951 9.08144 50.5908Z"
          fill="currentColor"
        />
        <path
          ...
          28.9121 86.7994 32.2913 88.1811 35.8758C89.083 
